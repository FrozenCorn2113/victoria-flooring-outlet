  ...
  const bodyHtml = `
    ...
    <div style="background-color: ${BRAND.bgSection}; padding: 20px; border-radius: 6px; margin: 24px 0;">
      ...
      <ul style="margin: 0; padding-left: 20px; color: ${BRAND.textPrimary}; font-size: 15px; line-height: 1.8; font-family: ${BRAND.fontStack};">
        ...
        <li><strong>Text support from Ty</strong> at ${BRAND.phone} for any questions</li>
      </ul>
    </div>
    ...
    <p style="margin: 24px 0 0; color: ${BRAND.textSecondary}; font-size: 14px; line-height: 1.6; font-family: ${BRAND.fontStack};">
      Got questions? Text Ty at <a href="sms:7788717681" style="color: ${BRAND.accent}; text-decoration: none; font-weight: 600;">${BRAND.phone}</a> – he's here to help!
    </p>
...
• Text support from Ty at ${BRAND.phone} for any questions
...
Got questions? Text Ty at ${BRAND.phone} – he's here to help!

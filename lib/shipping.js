...
const SHIPPING_ZONES = {
  // Zone 1: Greater Victoria - $3/box
  victoria: {
    name: 'Greater Victoria',
    ratePerBox: 300, // $3.00 per box
    prefixes: ['V8N', 'V8P', 'V8R', 'V8S', 'V8T', 'V8V', 'V8W', 'V8X', 'V8Y', 'V8Z', 'V9A', 'V9B', 'V9C']
  },
  // Zone 2: Rest of Vancouver Island - $5/box
  island: {
    name: 'Vancouver Island',
    ratePerBox: 500, // $5.00 per box
    prefixes: ['V9E', 'V9G', 'V9J', 'V9K', 'V9L', 'V9M', 'V9N', 'V9P', 'V9R', 'V9S', 'V9T', 'V9V', 'V9W', 'V9X', 'V9Y', 'V9Z', 'V0R']
  },
  // Zone 3: Lower Mainland & Fraser Valley - $4/box (close to Richmond warehouse)
  mainland: {
    name: 'Lower Mainland',
    ratePerBox: 400, // $4.00 per box
